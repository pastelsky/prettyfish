...
export type TemplateIcon = ComponentType<{ className?: string }>

export const FALLBACK_TEMPLATE_ICON = FlowchartIcon

export const TEMPLATE_ICONS: Record<string, TemplateIcon> = ICON_MAP
