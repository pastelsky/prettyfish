    ...
    <div className={chromePillClass()}>
      ...
      >
        ...
        {!mcpConnected && !mcpSessionReady && (
          <span className="hidden lg:inline text-[9px] font-semibold tracking-wide uppercase px-1 py-0.5 rounded bg-amber-400/20 dark:bg-amber-400/15 text-amber-600 dark:text-amber-400 leading-none">beta</span>
        )}
      </ChromeTextButton>
    </div>
  )
